...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i547.ApiClient>(() => registerModule.apiClient(
          gh<_i519.Client>(),
          gh<_i253.SecureStorageService>(),
        ));
    ...
    gh.lazySingleton<_i867.OrderLocalDatasource>(() =>
        _i867.OrderLocalDatasourceImpl(cacheService: gh<_i659.CacheService>()));
    gh.lazySingleton<_i928.SettlementRemoteDatasource>(() =>
        _i928.SettlementRemoteDatasourceImpl(apiClient: gh<_i547.ApiClient>()));
    ...
    gh.lazySingleton<_i562.RiderRepository>(() => _i1014.RiderRepositoryImpl(
          remoteDatasource: gh<_i4.RiderRemoteDatasource>(),
          networkInfo: gh<_i725.NetworkInfo>(),
        ));
    gh.lazySingleton<_i368.ShopRepository>(() => _i984.ShopRepositoryImpl(
    ...
    gh.lazySingleton<_i788.AdminRepository>(() => _i179.AdminRepositoryImpl(
    ...
    gh.lazySingleton<_i524.AdRepository>(() => _i451.AdRepositoryImpl(
    ...
    gh.lazySingleton<_i417.AuthRepository>(() => _i875.AuthRepositoryImpl(
    ...
    gh.factory<_i520.AdminCubit>(() => _i520.AdminCubit(
    ...
    gh.factory<_i580.PointsCubit>(() => _i580.PointsCubit(
    ...
    gh.factory<_i615.CategoriesCubit>(() => _i615.CategoriesCubit(
    ...
    gh.factory<_i786.CustomerProfileCubit>(() => _i786.CustomerProfileCubit(
    ...
    gh.factory<_i221.ShopManagementCubit>(() => _i221.ShopManagementCubit(
    ...
    gh.factory<_i517.OrderCubit>(() => _i517.OrderCubit(
    ...
    gh.factory<_i116.RiderCubit>(() => _i116.RiderCubit(
